...
def call_gemini_api(prompt: str, context: str, api_key: str) -> Optional[str]:
    ...
    try:
        ...
        system_instruction = (
            "You are the COEP Research Intelligence AI Copilot for COEP Technological University, Pune (Unitary Public Technological University of Maharashtra, Estd. 2022). "
